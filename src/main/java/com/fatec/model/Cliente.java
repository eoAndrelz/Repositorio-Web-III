...
public class Cliente {
	...
	private String nome;
	@Pattern(regexp = "^(0?[1-9]|[12][0-9]|3[01])[\\/-](0?[1-9]|1[012])[\\/-]\\d{4}$", message = "A data de nascimento deve estar no formato dd/MM/YYYY") // https://www.regular-expressions.info/
	private String dataNascimento;
	private String dataCadastro;
	@NotBlank(message = "Sexo M/F")
	private String sexo;
	@CPF
	@Column(unique = true) // nao funciona com @Valid tem que tratar na camada de persistencia private
	String cpf;
	...
	public boolean validaData(String data) { 
							...
							df.setLenient(false); //
							try { df.parse(data); // data válida (exemplo 30 fev - 31 nov) 
